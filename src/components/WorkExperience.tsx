  ...
  const experiences = [
    {
      ...
      type: "Full-time",
      description:
        "Developing scalable software solutions and cloud-based applications using modern technologies.",
      icon: Briefcase,
      color: "blue",
      status: "current",
    },
    ...
    },
    {
      ...
      type: "Internship",
      description:
        "Developed React + Azure Functions web application with focus on cloud integration and modern frontend practices.",
      icon: Zap,
      color: "cyan",
      status: "completed",
    },
      ...
      <div className="container relative z-10 mx-auto px-2">
        ...
        <div ref={containerRef} className="mx-auto max-w-4xl">
          <div className="relative">
            ...
            <div className="absolute left-4 md:left-1/2 md:-translate-x-0.5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-white/30 via-white/20 to-white/10 shadow-lg"></div>

            {/* Timeline glow effect */}
            <div className="absolute left-4 md:left-1/2 md:-translate-x-1 top-0 bottom-0 w-2 bg-gradient-to-b from-blue-600/20 via-purple-600/10 to-transparent blur-sm"></div>
                  ...
                  >
                    ...
                    <div
                      className={`w-full md:w-5/12 ${
                        isLeft
                          ? "md:mr-auto md:pr-8 ml-16 md:ml-0"
                          : "md:ml-auto md:pl-8 ml-16"
                      }`}
                    >
                      <motion.div
                      ...
                      >
                        ...
                        {/* Subtle accent line */}
                        <div
                          className={`mt-4 h-0.5 w-12 bg-gradient-to-r from-${experience.color}-400 to-transparent opacity-60`}
                        ></div>
                      </motion.div>
                    </div>
                  </motion.div>
